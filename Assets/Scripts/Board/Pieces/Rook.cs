...
namespace Board.Pieces
{
    public class Rook : Piece
    {
        ...
        public const char BlackCharacter = 'r';
        public const char WhiteCharacter = 'R';
        public const char MoveCharacter = 'R';

        public override char PieceCharacter => Color == PieceColor.White ? WhiteCharacter : BlackCharacter;

        public readonly static PieceTypes PieceType = PieceTypes.Rook;
